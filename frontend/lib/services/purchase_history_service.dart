...
class PurchaseHistoryService {
  ...
  Future<List<PurchaseHistoryItem>> getPurchaseHistory() async {
    ...
    var response = await apiService.makeApiGetRequest('$apiHost/purchase_history?user_id=$userId');
    var decodedBody = json.decode(response.body);
    PurchaseHistoryDto decodedResponse = PurchaseHistoryDto.fromJson(decodedBody);
